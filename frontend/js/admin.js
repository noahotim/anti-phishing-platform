  ...
  function renderSettings(view) {
    ...
    Promise.all([API.getThresholds(), API.getWhitelistOnly().catch(function () { return { enabled: false }; })])
      .then(function (res) {
        ...
        var goPolicy = document.getElementById("wl-go-policy");
        if (goPolicy) goPolicy.addEventListener("click", function (e) { e.preventDefault(); document.querySelector('[data-tab="blocked"]').click(); });
